...
router.post("/wishlists/add-book/:wishlistId/:bookId", WishlistManagementController.postBook); 
router.delete("/wishlists/add-to-cart/:wishlistId/:bookId", WishlistManagementController.deleteToCart); 
router.get("/wishlists/view/:name", WishlistManagementController.getWishlist); 

// Additional Feature: 
router.delete("/wishlists/delete-book/:wishlistId/:bookId", WishlistManagementController.deleteBook); 
